/*
Find the most optimal skills using order by both salary average and demand count(job count).
Swtich between job count and salary as order by 
*/
...
--Combine the above into one query
SELECT
    skills_dim.skill_id,
    skills_dim.skills,
    COUNT (skills_job_dim.job_id) AS demand_count,
